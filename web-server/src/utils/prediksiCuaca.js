...
// Cache sederhana di memori untuk respons prediksi, key = "lat,lon".
// Tujuan: mengurangi jumlah permintaan ke layanan eksternal yang berpotensi terkena rate-limit.
...
// Helper cache: baca entry jika belum kedaluwarsa.
const getCached = (key) => {
...
// Helper: simpan value ke cache (best-effort)
...
// Helper: simpan error ke cache (negative caching)
...
const forecast = async (latitude, longitude, callback, options = {}) => {
  ...
  // Helper: tangani fallback ke Open-Meteo
