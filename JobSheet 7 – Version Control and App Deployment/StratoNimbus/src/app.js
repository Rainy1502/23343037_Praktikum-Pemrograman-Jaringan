...
// Health check (untuk readiness/liveness probes)
...
app.get('/berita', async (req, res) => {
  ...
  const cached = (!refresh) ? await getCachedNews() : null;
  if (cached) {
...
// Export app agar bisa dipakai baik oleh server lokal (`src/server.js`) maupun
// oleh serverless wrapper (`api/index.js`) untuk deployment di Vercel.
export default app;